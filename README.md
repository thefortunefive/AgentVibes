...
**Author**: Paul Preibisch ([@997Fire](https://x.com/997Fire)) | **Version**: v3.5.4
...
**🪟 NEW IN v3.5.4 — Native Windows Support:**
...
- [📰 Latest Release](#-latest-release) - v3.5.4 - Native Windows Support with Soprano, Piper & SAPI
...
**[v3.5.4 - Native Windows Support: Soprano, Piper & SAPI Providers](https://github.com/paulpreibisch/AgentVibes/releases/tag/v3.5.4)** 🪟🎤
